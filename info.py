...
BOT_TOKEN = environ.get('BOT_TOKEN', "7049095599:AAHWSILc6ujrcmwDmf7z3n95yIWH_ys0Kgw")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002065495948').split()]
...
URL = "https://demo-5wfq.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-5wfq.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-5wfq.onrender.com/".format(FQDN)
else:
    URL = "https://demo-5wfq.onrender.com/".format(FQDN)
